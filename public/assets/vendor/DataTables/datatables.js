 ...
 *   https://datatables.net/download/#bs5/dt-1.13.1/date-1.2.0/fc-4.2.1/fh-3.3.1/r-2.4.0
 *
 * Included libraries:
 *   DataTables 1.13.1, DateTime 1.2.0, FixedColumns 4.2.1, FixedHeader 3.3.1, Responsive 2.4.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs5/dt-1.13.1/date-1.2.0/fc-4.2.1/fh-3.3.1/r-2.4.0",
