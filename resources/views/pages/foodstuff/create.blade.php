...
<x-app-layout dashboard title="Tambah Bahan Makanan">
  @push('styles')
    ...
    <div class="col col-sm-11 col-md-8 col-lg-6">
      <div class="container-fluid border rounded-4 shadow p-3">
        <form action="{{ route('foodstuff.store') }}" method="POST" id="createFoodstuffForm">
          ...
          <x-form.floating-input name="name" aliasName="slug" class="mb-3" autofocus>Nama Bahan Makanan</x-form.floating-input>
          <x-form.floating-input-group type="number" name="price" class="mb-3">
